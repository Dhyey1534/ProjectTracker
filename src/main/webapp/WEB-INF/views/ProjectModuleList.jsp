									...
									<table border="1" class="table datatable datatable-table table-hover" id="myTable">
											...
											<c:forEach items="${projectModuleList}" var="pM">
													<tr>
														...
														<td>${pM.status}</td>
														<td>${pM.startDate}</td>
														<td><a href="viewprojectmodule?moduleId=${pM.moduleId}">View</a> | <a href="deleteprojectmodule?moduleId=${pM.moduleId}">Delete</a> | <a href="editprojectmodule?moduleId=${pM.moduleId}">Edit</a></td>
													</tr>
											</c:forEach>
